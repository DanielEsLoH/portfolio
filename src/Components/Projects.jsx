import flowoverstack from '../assets/flowoverstack.png';
  ...
  return (
    <div id='Projects' className="p-20 flex flex-col items-center justify-center">
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 justify-around gap-10">
        ...
        <div>
          <div>
            <img data-aos="fade-up" height={250} width={250} className="flex items-center justify-center rounded-3xl p-1 border-2 border-fuchsia-800 b_glow" src={flowoverstack} alt="" />
          </div>
          <div className='flex justify-center items-center my-4'>
            <a href="https://github.com/DanielEsLoH/flowoverstack" target="_blank" className="text-fuchsia-600 hover:text-fuchsia-500 rounded-full glow p-2">
                <AiFillGithub className="text-[28px]" />
            </a>
            <a href="https://flowoverstack.fly.dev/" target="_blank" className="text-fuchsia-600 hover:text-fuchsia-500 rounded-full glow p-2">
                <FaGlobe className="text-[28px]" />
            </a>
          </div>
        </div>
